 ...
 */
@WebServlet("/ProductCompleteServlet")
public class ProductCompleteServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if (request.getParameter("action").equals("register")) {
            RequestDispatcher result = request.getRequestDispatcher("/productComplete.jsp");
            result.forward(request, response);
        } else if (request.getParameter("action").equals("back")) {
            RequestDispatcher result = request.getRequestDispatcher("/productinput.jsp");
            result.forward(request, response);
        }
    }
